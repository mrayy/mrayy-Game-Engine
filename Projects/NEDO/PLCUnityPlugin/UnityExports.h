...
extern "C" EXPORT_API void PLCSetYbmUInt(PLCHandler* driver, EXyrisDataField data, unsigned int v);
extern "C" EXPORT_API void PLCSetYbmUShort(PLCHandler* driver, EXyrisDataField data, unsigned short v);
extern "C" EXPORT_API unsigned int PLCGetYbmUInt(PLCHandler* driver, EXyrisDataField data);
extern "C" EXPORT_API unsigned short PLCGetYbmUShort(PLCHandler* driver, EXyrisDataField data);