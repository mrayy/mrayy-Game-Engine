// HapticInputModule.cpp : Defines the exported functions for the DLL application.
//

#include "stdafx.h"
#include "TxHapticInputModule.h"
...
public:
	...
	TxHapticInputService* GetService()
	{
		return m_impl;
	}
...
{
	m_impl = new TxHapticInputService();
...
HapticInputMODULE_API void  DLL_SreviceDestroy()
{
