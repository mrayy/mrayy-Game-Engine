...
#ifndef __TxEarsService__
#define __TxEarsService__
...
namespace TBee
{
	...
	class TxEarsServiceImpl;
class TxEarsService:public IServiceModule
{
public:
	...
	DECLARE_RTTI
protected:
	TxEarsServiceImpl* m_impl;
public:
	TxEarsService();
	virtual ~TxEarsService();
