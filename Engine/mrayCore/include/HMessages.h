...
MRAY_CORE_DLL const mchar* getMessage(int msgCode);
MRAY_CORE_DLL void logMessage(int msgCode, ELogLevel level);
MRAY_CORE_DLL void logMessage(const mchar*msg, ELogLevel level);
