...
class MRAY_CORE_DLL IResourceManager;
class MRAY_CORE_DLL IResource;
class MRAY_CORE_DLL IAsyncLoadRequest;

typedef ulong ResourceHandle;
class MRAY_CORE_DLL ResourceListner
{
public:
...
class MRAY_CORE_DLL  IResource:public IObject
{
	DECLARE_RTTI
public:
...
protected:
	...
	friend class MRAY_CORE_DLL IResourceManager;
