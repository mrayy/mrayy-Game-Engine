...
MRAY_CORE_DLL int wchar_to_char(char*a,const  wchar_t *b);
MRAY_CORE_DLL int wchar_to_char(const  wchar_t *in, stringc&str);
MRAY_CORE_DLL int char_to_wchar(wchar_t*a, const char*b);
MRAY_CORE_DLL int char_to_wchar(const char *in, stringw&str);

MRAY_CORE_DLL int char_to_string(const char *in, string&str);
MRAY_CORE_DLL string char_to_string(const char *in);

MRAY_CORE_DLL int wchar_to_string(const wchar_t *in, string&str);
MRAY_CORE_DLL string wchar_to_string(const wchar_t *in);

MRAY_CORE_DLL int string_to_wchar(const string &in, stringw&str);
MRAY_CORE_DLL stringw string_to_wchar(const string &in);

MRAY_CORE_DLL stringc string_to_char(const string &in);
MRAY_CORE_DLL int string_to_char(const string &in, stringc&str);
