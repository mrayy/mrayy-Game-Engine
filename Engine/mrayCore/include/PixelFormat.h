...
class MRAY_CORE_DLL IColorDesciptor{
public:
...
class MRAY_CORE_DLL GrayColorDesciptor{
public:
	byte c;
...
class MRAY_CORE_DLL RGBColorDesciptor{
public:
	byte r,g,b;
	virtual ulong toLong(){
...
class MRAY_CORE_DLL BGRColorDesciptor{
public:
	byte b,r,g;
	virtual ulong toLong(){
...
class MRAY_CORE_DLL RGBAColorDesciptor{
public:
	byte r,g,b,a;
	virtual ulong toLong(){
...
class MRAY_CORE_DLL PixelFormat
{
public:
...
class MRAY_CORE_DLL UnkownPixelFormat:public PixelFormat
{
public:
...
class MRAY_CORE_DLL GrayPixelFormat:public PixelFormat
{
public:
	int getDepth();
...
class MRAY_CORE_DLL RGBPixelFormat:public PixelFormat
{
public:
	int getDepth();
	int getComponentsCount();
...
class MRAY_CORE_DLL BGRPixelFormat:public PixelFormat
{
public:
	int getDepth();
	int getComponentsCount();
...
class MRAY_CORE_DLL RGBAPixelFormat:public PixelFormat
{
public:
	int getDepth();
	int getComponentsCount();
