...
/********************************************************************
	...
	purpose:	this will reformat the log string to a certain class MRAY_CORE_DLL based on the system type
*********************************************************************/
...
class MRAY_CORE_DLL LogSubsystem
{
private:
protected:
...
class LoggerSystem##SystemName:public ISingleton<LoggerSystem##SystemName>,public LogSubsystem\
{\
public:\
