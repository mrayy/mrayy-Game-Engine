...
class MRAY_CORE_DLL ISocket;
class MRAY_CORE_DLL CMsgBuffer;
enum ESendMode;

class MRAY_CORE_DLL NetPacket {
...
class MRAY_CORE_DLL PeerDisconnect:public NetPacket
{
protected:
public:
...
class MRAY_CORE_DLL ServerInfo:public NetPacket
{
protected:
public:
	virtual void writeData(mray::network::CMsgBuffer*buffer);
