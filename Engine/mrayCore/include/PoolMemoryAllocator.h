...
class MRAY_CORE_DLL  PoolMemory
{
private:
protected:
	typedef uchar Byte;
...
template <typename T> class MRAY_CORE_DLL PoolMemoryAllocator;

template <> class MRAY_CORE_DLL PoolMemoryAllocator<void>
{
public:
...
template <typename T>
class MRAY_CORE_DLL PoolMemoryAllocator
{
public:
