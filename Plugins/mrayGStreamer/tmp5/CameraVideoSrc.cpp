...
std::string CameraVideoSrc::GetPipelineStr(int)
{
	...
	if (camsCount == 0)
		return "videotestsrc ! video/x-raw,width=" + core::StringConverter::toString(m_impl->m_frameSize.x) +
